...
> チーム運営のための AI Co-pilot Platform — 見えていないものを、AI が見続ける
...
下記の 6 アカウントが用意されています。**パスワードは申請時に個別にお送りします**（公開リポジトリ・ドキュメントには記載していません）。管理者アカウント (`tanaka.ken@atlaslens.dev`) でログインすると全機能を試せます。

| メール | 用途 |
|---|---|
| `tanaka.ken@atlaslens.dev` | 管理者・チーム運営側（田中 健） |
...
チーム運営業務を 5 つのモジュールで支援する Agentic AI プラットフォーム。
